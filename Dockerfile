...
RUN cd /fiji/plugins && wget -O mcib3d-core-3.96.jar https://imagejdocu.tudor.lu/_media/plugin/stacks/3d_ij_suite/mcib3d-core-3.96.jar
RUN cd /fiji/plugins && wget -O mcib3d_plugins-3.96.jar https://imagejdocu.tudor.lu/_media/plugin/stacks/3d_ij_suite/mcib3d_plugins-3.96.jar

# ---------------------------------------------------------------------------------------------------------------------
# Install Macro
ADD IJSpotDetectionHessian3D.ijm /fiji/macros/macro.ijm
